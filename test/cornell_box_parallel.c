...
static void build_cornell_box(NaiveScene* scene) {
  ...
  *mat_alpha_025 = build_alpha_material(0.25);
  ...
  add_triangle_nscene(scene, light_1);
  ...
  add_triangle_nscene(scene, light_2);
  ...
  add_sphere_nscene(scene, sphere);
  ...
  add_sphere_nscene(scene, metal_sphere);
  ...
  add_sphere_nscene(scene, glass_sphere);
  ...
  add_triangle_nscene(scene, alpha_tri);
  ...
  add_triangle_nscene(scene, alpha_tri_2);
  ...
  add_sphere_nscene(scene, alpha_sphere);
}
